...
import com.websarva.wings.android.insecureshoppoc.databinding.FragmentCode1Binding
import com.websarva.wings.android.insecureshoppoc.ui.fragment.InfoDialogFragment
import dagger.hilt.android.AndroidEntryPoint

@AndroidEntryPoint
class Code1Fragment: Fragment() {
    private var _binding: FragmentCode1Binding? = null
    private val binding
    get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = FragmentCode1Binding.inflate(inflater, container, false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btDisplay.setOnClickListener {
            activity?.let {
                InfoDialogFragment(getString(R.string.mstg_code_1_title), getString(
                    when(binding.radioGroup.checkedRadioButtonId){
                        binding.rb1.id -> {
                            R.string.mstg_code_1_1_message
                        }
                        binding.rb2.id -> {
                            R.string.mstg_code_1_2_message
                        }
                        else -> {
